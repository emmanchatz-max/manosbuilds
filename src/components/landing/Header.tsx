      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between rounded-full border border-white/10 bg-[rgba(6,16,31,0.58)] px-4 py-3 shadow-[0_14px_50px_rgba(0,0,0,0.25)] backdrop-blur-2xl sm:px-6">
        <a href="#top" className="group flex items-center gap-3">
          <div className="relative flex items-center gap-3">
            <span className="absolute inset-0 rounded-full bg-[radial-gradient(circle_at_center,rgba(85,135,255,0.26),transparent_60%)] blur-xl" />
            <div className="relative flex min-h-11 min-w-11 items-center justify-center rounded-full border border-sky-300/18 bg-white/[0.045] px-3 py-2">
              <LogoImage
                className="max-h-8 w-auto object-contain"
                textClassName="min-w-[8.5rem]"
              />
            </div>
          </div>
        </a>
